...
public class BigChestTileEntityRender<T extends TileEntity & IChestLid> extends ChestTileEntityRenderer<T> {
    ...
    public BigChestTileEntityRender(TileEntityRendererDispatcher rendererDispatcherIn) {
